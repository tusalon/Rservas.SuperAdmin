...
// ==================== RENDERIZADO DE LISTA (CON MENÚ RESPONSIVE) ====================
        ...
        html += `
            <div class="bg-white rounded-lg shadow border-l-4 ${ec.color} p-4 fade-in">
                <div class="flex flex-col md:flex-row justify-between items-start gap-3">
                    ...
                    <div class="relative">
                        <button onclick="toggleMenu('menu-${n.id}')" class="bg-gray-100 hover:bg-gray-200 px-4 py-2 rounded-lg text-sm w-full md:w-auto">⚙️ Acciones ▼</button>
                        <div id="menu-${n.id}" class="hidden fixed left-1/2 transform -translate-x-1/2 md:absolute md:right-0 md:left-auto md:transform-none mt-2 w-[280px] md:w-56 bg-white rounded-lg shadow-xl z-50 border overflow-hidden" style="top: auto; max-width: calc(100vw - 32px);">
                            <div class="py-1">
